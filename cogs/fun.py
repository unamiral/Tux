...
class Fun(commands.Cog):
    ...
    async def quote(self, ctx):
        ...
        embed.set_author(
            name=json_data[0]["a"],
            icon_url=
            "https://media.istockphoto.com/photos/magic-book-open-picture-id1210557301?b=1&k=20&m=1210557301&s=170667a&w=0&h=wWIp4fUJTG_5afInjVGrXN34ny0MSnC9xY9WAEqhl38="
        )
