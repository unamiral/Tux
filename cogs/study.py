...
class Study(commands.Cog):
    ...
    async def conj(self, ctx, *, verbe):
        ...
        embed.add_field(name="Présent", value=f"Je **{res['Présent']['1s']}**\n  Tu **{res['Présent']['2s']}**\n  Il/Elle/On **{res['Présent']['3s']}**\n  Nous **{res['Présent']['1p']}**\n  Vous **{res['Présent']['2p']}**\n  Ils/Elles **{res['Présent']['3p']}**\n")
    ...
    async def pi(self, ctx):
      ...
      embed.set_footer(text="The number π (/paɪ/; spelled out as \"pi\") is a mathematical constant, approximately equal to 3.14159. It is defined in Euclidean geometry[a] as the ratio of a circle's circumference to its diameter, and also has various equivalent definitions. The number appears in many formulas in all areas of mathematics and physics. The earliest known use of the Greek letter π to represent the ratio of a circle's circumference to its diameter was by Welsh mathematician William Jones in 1706.[1]It is also referred to as Archimedes's constant. wikipedia")
      embed.set_thumbnail(url="https://upload.wikimedia.org/wikipedia/commons/thumb/2/2e/Pi-symbol.svg/1058px-Pi-symbol.svg.png")
